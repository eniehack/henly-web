...
test('Entity#getQuery/1', () => {
	...
	const id = new ServiceIdentity('Exodus 0.9.1', 'client', undefined, 'pc');
	let entity = new Entity(id, features);
	let root_xml: Element = entity.getQuery(
		jid('alice', 'example.com', 'test'),
		jid('bob', 'example.com', 'test'),
		'test',
		'https://github.com/eniehack/henly-web-viewer#QgayPKawpkPSDYmwT/WM94uAlu0='
	);
	...
	expect(query_xml.attrs.node).toBe(
		'https://github.com/eniehack/henly-web-viewer#QgayPKawpkPSDYmwT/WM94uAlu0='
	);
